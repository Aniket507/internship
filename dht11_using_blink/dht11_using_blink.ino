...
#define BLYNK_TEMPLATE_ID "TMPLYm53wJmN"
#define BLYNK_DEVICE_NAME "DHT11 using blynk"
#define BLYNK_AUTH_TOKEN "aGoHDq94J-nan2Na7sLpybo6OXNNCyUu"
...
char ssid[] = "OPPO A53";///Enter your wifi name
char pass[] = "aniket123";// Enter wifi password
